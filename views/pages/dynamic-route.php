...
<head>
    ...
    <title>Dynamic route | Router boilerplate</title>
...
<body style="font-family: Arial, Helvetica, sans-serif; display: grid; place-items: center">
    <div>
        <div style="margin-top: 100px; display: flex; align-items: center; gap: 20px;">
            ...
            <big style="border-left: 1px solid black; padding: 10px 20px; font-size: 20px; line-height: 20px;"><?= $this->getParameter('slug') ?></big>
        </div>
        <hr>
